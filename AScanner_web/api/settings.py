...
class Settings():
        ...
        if method == "get":
            ...
            for config_section in list(self.ascanner.config.conf_default.keys()):
                ...
                for config_item in list(self.ascanner.config.conf_default[config_section].keys()):
                    ...
                    if self.ascanner.config.conf_default[config_section][config_item]["config_web_hidden"]:
            ...
            self.ascanner.config.write(config_name, config_value, config_section)
    ...
    def restart_thread(self):
        ...
        try:
            self.ascanner.api.get(self.restart_url)
