...
class PluginsHandler():
    """
    ascanner plugins handling.
    """

    def __init__(self, settings, logger, versions, deps):
    ...
    def load_plugins(self):
        ...
        for plugin_name, plugin_path, plugin_conf, plugin_manifest in self.found_plugins:
            plugin_item = Plugin(self.config, self.logger, self.versions, plugin_name, plugin_path, plugin_conf, plugin_manifest)
