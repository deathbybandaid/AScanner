...
class Plugin():
    ...
    def __init__(self, config, logger, versions, plugin_name, plugin_path, plugin_conf, plugin_manifest):
        self.config = config
        self.logger = logger
        ...
        self.plugin_utils = Plugin_Utils(config, logger, versions, plugin_name, plugin_manifest, self.modname, self.path)
