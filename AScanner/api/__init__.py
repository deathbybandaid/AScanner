...
class Fillin_Client():
    """
    Until AScanner_web is loaded, use requests for internal API calls.
    """
...
class AScanner_API_URLs():
    """
    Methods for calling the AScanner_web internally.
    """
    ...
    def __init__(self, settings, web, versions, logger):
        ...
        self.headers = {'User-Agent': "AScanner/%s" % self.versions.dict["AScanner"]}
    ...
    def address(self):
        """
        A reference to the address AScanner is set to run on.
        """

        return self.config.dict["ascanner"]["address"]

    @property
    def discovery_address(self):
        """
        A reference to the discovery address AScanner is set to run on.
        """

        return self.config.dict["ascanner"]["discovery_address"]

    @property
    def port(self):
        """
        A reference to the port AScanner is set to run on.
        """

        return self.config.dict["ascanner"]["port"]

    def no_response_get(self, url, *args):
        """
        A method to simulate a GET request to the AScanner_web API internally, but without waiting for a response.
        """
    ...
    def no_response_post(self, url, *args):
        """
        A method to simulate a POST request to the AScanner_web API internally, but without waiting for a response.
        """
        self.logger.debug("Using a GET request to %s without waiting for a response" % url)
    ...
    def threadget(self, url, *args):
        """
        A method to simulate a GET request to the AScanner_web API internally, but in a seperate thread.
        """
    ...
    def threadpost(self, url, *args):
        """
        A method to simulate a POST request to the AScanner_web API internally, but in a seperate thread.
        """
    ...
    def get(self, url, *args):
        """
        A method to simulate a GET request to the AScanner_web API internally.
        """
    ...
    def post(self, url, *args):
        """
        A method to simulate a POST request to the AScanner_web API internally.
        """
    ...
    def discovery_address_tuple(self):
        """
        A tuple of the discovery address and the port set for AScanner.
        """
    ...
    def address_tuple(self):
        """
        A tuple of the address and the port set for AScanner.
        """
